...
<details open="open">
  ...
  <ol>
    <li>
      <a href="#Σχετικά">Σχετικά με το παιχνίδι</a>
      <ul>
	 <li><a href="#βάση">Η βάση</a></li>
	      <li><a href="#χρησιμοποιήθηκαν">Τεχνολογίες που χρησιμοποιήθηκαν</a></li>
        <li><a href="#Περιγραφή">Περιγραφή του παιχνιδιού</a></li>
      </ul>
    </li>
    <li>
      <a href="#Αρχικά">Αρχικά</a>
      <ul>
        <li><a href="#Απαραίτητες">Προαπαιτούμενες τεχνολογίες</a></li>
      </ul>
    </li>
